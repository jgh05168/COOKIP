...
const fetchUserData = async () => {
  try {
    const userResponse = await axios.get(authStore.urlUser);
    // const userProfileResponse = await axios.get(authStore.urlUserProfile);
    authStore.memberList = userResponse.data;
    // authStore.userProfileList = userProfileResponse.data;
  } catch (error) {
