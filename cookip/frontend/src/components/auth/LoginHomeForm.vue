                ...
                <div class="div-wrapper">
                  <div class="frame-4">
                    <div class="continue-wrapper">
                      <v-btn @click="goLogin" class="continue" color="#007aff" dark elevation="2">Login</v-btn>
                    </div>
                    <div class="continue-with-apple-wrapper">
                      <v-btn @click="goSignUp" class="continue-with-apple" color="white" dark elevation="2">Sign up</v-btn>
                    </div>
                  </div>
                </div>
              </div>
...
const goSignUp = function() {
  ...
  .login-or-sign-up .what-s-your-phone {
    color: #1a1c29;
  ...
  .login-or-sign-up .enter-phone-number {
    align-self: stretch;
    color: #797979;
  ...
  .login-or-sign-up .continue-wrapper {
    align-items: center;
    align-self: stretch;
    border-radius: 14px;
    display: flex;
  ...
  .login-or-sign-up .continue-with-apple-wrapper {
    align-items: center;
    align-self: stretch;
    border-radius: 14px;
    display: flex;
  ...
  .continue-with-apple-wrapper .continue-with-apple {
    height: 50px;
    border-radius: 14px;
    color:  white;
    font-family: "Roboto-SemiBold", Helvetica;
  ...
  .login-or-sign-up .if-you-are-creating-wrapper {
    align-items: center;
    align-self: stretch;
    display: flex;
    height: 58px;
  ...
  .login-or-sign-up .if-you-are-creating {
    color: #797979;
    flex: 1;
    font-family: "Roboto-Regular", Helvetica;
    font-size: 12px;
